...
client.login("ODc1MzY0MzE4NzgxMjQzNDIz.YRUcjQ.DMwOasTkv1eUcufheQKU012buRE");
...
client.on("ready", () => {
    ...
    client.user.setActivity('BETA 1.0 SERVER GICH', {
      type: 'PLAYING'
    });
});
...
client.on("messageReactionAdd", async function (messageReaction, user) {
    ...
    if (messageReaction._emoji.name == "📩") { //Personalizzare l'emoji della reaction
        if (messageReaction.message.channel.id == "875128266091003924") { //Settare canale
            ...
            server.channels.create(user.username, {
                ...
                canale.setParent("875122349324787725") //Settare la categoria
